...
from kleinanzeigen_bot import publishing_flow as _publishing_flow
...
class TestKleinanzeigenBotBasics:
    ...
    async def test_publish_ad_keeps_pre_submit_timeouts_retryable(
        ...
        with (
            ...
            patch.object(test_bot, "_dismiss_consent_banner", new_callable = AsyncMock),
            patch.object(_publishing_flow.PublishingFormFlow, "_set_category", new_callable = AsyncMock, side_effect = TimeoutError("image upload timeout")),
    ...
    def _mock_post_submit_dependencies(
        ...
        *,
        ...
        common_patches:list[Any] = [
            ...
            patch.object(test_bot, "_dismiss_consent_banner", new_callable = AsyncMock),
            patch.object(_publishing_flow.PublishingFormFlow, "_set_category", new_callable = AsyncMock),
            patch.object(_publishing_flow.PublishingFormFlow, "_set_special_attributes", new_callable = AsyncMock),
            patch.object(_publishing_flow.PublishingFormFlow, "_set_contact_fields", new_callable = AsyncMock),
...
class TestKleinanzeigenBotShippingOptions:
    ...
    async def test_auto_price_reduction_conditional_on_mode_and_on_update(
        ...
        with (
            ...
            patch.object(_publishing_flow.PublishingFormFlow, "_set_contact_fields", new_callable = AsyncMock),
            patch("builtins.input", return_value = ""),
            patch("kleinanzeigen_bot.publishing_flow.ainput", new_callable = AsyncMock, return_value = ""),
        ):
            test_bot.page = MagicMock()
            test_bot.page.url = "https://www.kleinanzeigen.de/p-anzeige-aufgeben-bestaetigung.html?adId=12345"
...
class TestWantedShippingSelection:
    ...
    def _mock_publish_dependencies(
        ...
        with (
            ...
            patch.object(_publishing_flow.PublishingFormFlow, "_set_category", new_callable = AsyncMock),
            patch.object(_publishing_flow.PublishingFormFlow, "_set_special_attributes", new_callable = AsyncMock),
            patch.object(_publishing_flow.PublishingFormFlow, "_set_shipping", new_callable = AsyncMock),
            patch.object(_publishing_flow.PublishingFormFlow, "_set_contact_fields", new_callable = AsyncMock),
            patch.object(_publishing_flow.PublishingFormFlow, "_upload_images", new_callable = AsyncMock),
...
class TestImageCleanupInPublishAd:
    ...
    async def test_existing_images_removed_before_upload(
        ...
        with (
            ...
            patch.object(test_bot, "web_sleep", new_callable = AsyncMock),
            patch.object(_publishing_flow.PublishingFormFlow, "_set_contact_fields", new_callable = AsyncMock),
            patch.object(_publishing_flow.PublishingFormFlow, "_upload_images", new_callable = AsyncMock, side_effect = upload_side_effect) as mock_upload,
            patch("kleinanzeigen_bot.captcha_flow.check_and_wait_for_captcha", new_callable = AsyncMock),
            patch.object(test_bot, "web_find", new_callable = AsyncMock),
